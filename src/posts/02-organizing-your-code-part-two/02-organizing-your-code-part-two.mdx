...
image: ./images/kelly-sikkema-unsplash.jpg
type: post
published: true
date: 02-11-2021
tags: [Gatsby, Emotion, Javascript, CSS, React, Organization]
---
![Photo by: Kelly Sikkema](./images/kelly-sikkema-unsplash.jpg)
...
This may seem like overkill, but this just helps with reusability. My styles are directly attached to each component and in the future when I need to reuse the nav-ul I will have consistant styling. 
