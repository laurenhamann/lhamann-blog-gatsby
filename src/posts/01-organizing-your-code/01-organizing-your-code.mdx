...
published: false
date: 02-10-2021
tags: [React, Gatsby, Emotion, Javascript, CSS]
---
![Photo by: Florian Klauer](./images/typography.jpg)  
  
    

## Keep your files organized for future changes  
...
I have created over 100 different websites. Most of them for practice and some for fun. One problem I always ran into was the CSS was so hard to keep track of. I would try and organize it by page or by size (mobile - desktop). Stil every time I would struggle after a while to figure out where the styles are for a certain element. Eventually, I would just add another instance of this element and move on. That only made it more disorganized and not to mention if I were to take a break from the project and come back I almost always would just scrap it because I never knew what was going on.  
Being organized is a big part of coding. Imagine if another person were to open up your project, would they know after a couple of minutes of poking around what was going on? Would they be able to pick up your project and get to work finishing it?  

### I'm sure that there are many ways to organize your files for styling. Here is mine:  


For this project, I am using Gatsby and Emotion for CSS. I mostly used styled from @emotion/styled. This was the best way I could think to achieve my file organization. 
First, create a folder called Global. This will hold all the reusable styles for most of the project. Inside my global folder, I started with colors.js, fonts.js, spacing.js.  
...
;
  ...
  /* elsie-swash-caps-900normal - latin */
const elsieSwash900 = `@font-face {
        font-family: 'Elsie Swash Caps';
        font-style: normal;
        font-display: swap;
        font-weight: 900;
        src:
        local('Elsie Swash Caps Black '),
        local('Elsie Swash Caps-Black'),
        url('./files/elsie-swash-caps-latin-900.woff2') format('woff2'), /* Super Modern Browsers */
        url('./files/elsie-swash-caps-latin-900.woff') format('woff'); /* Modern Browsers */
    }`
;
/* open-sans-condensed-300normal - latin */
const openSansCondensed300 = `@font-face {
...
const openSans300Italic = `@font-face {
    font-family: 'Open Sans';
    font-style: italic;
    font-display: swap;
    font-weight: 300;
...
const openSans400Italic = `@font-face {
        font-family: 'Open Sans';
        font-style: italic;
        font-display: swap;
        font-weight: 400;
...
const openSans700Italic = `@font-face {
        font-family: 'Open Sans';
        font-style: italic;
        font-display: swap;
        font-weight: 700;
...
export const fonts = {  openSans300,
                        openSans300Italic,
                        openSans400,
                        openSans400Italic,
                        openSans700,
                        openSans700Italic,
                        openSansCondensed300,
                        openSansCondensed700,
                        openSansCondenseditalic300,
                        elsie400,
                        elsie900,
                        elsieSwash400,
                        elsieSwash900 };
...
If this looks strange it is because I wanted to try and not use any media queries in this project. I find media queries to be extremely annoying to write. I hate how it just changes at a certain width and now with all the different screen sizes, it is impossible to make it look great on every screen. I chose to use the CSS clamp() for all of my font-sizes, widths, margins, and such. It has made my site way more responsive with a lot less coding.  
...
Okay, next I created a file called clamps.js. This became my hub for all my value objects so I could create the final variables holding my clamp() function. 
...
As you can see because the variable is an object all I have to put to call the object is `fontSize.spanSize.min` and get that value. 
So now your can see my font-styles.js file\
...
After a couple of weeks of multiple imports from various folders inside of global I decided to combine them inside a new file called global.js  
global.js holds all the imports from all the files and then exports them. I can still get my styles like before but now they are inside one import statement. 
...
I was using the CSS attribute that comes with emotion/react but I found it to be extremely messy. All my files have a styled component wrapped around. 

For example, my about page has a folder called about --> styles --> about-styles.js 
...
As you can see I can use my clamps for a uniform styling approach. No more random spacing, everything is spaced equally, with the clamps variables. 
This gets imported into my about.js files inside of the pages folder and wraps around the jsx. 
Take a look at my GitHub to see all the folders inside of the component and how they are laid out. 
[Github Code](https://github.com/LaurenwallerDesigns/lhamann-blog-gatsby).  
