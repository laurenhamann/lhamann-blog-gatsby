import { width } from '../Sizes/__div';
import { h1, h2, h3, h4, p,  largeLink, spanSmall, span, logo, intro, anchor, nav  } from '../Sizes/__fonts';
import {marginMed, marginRL, marginTB, marginXS, sectionBtnMB}  from '../Sizes/__margin'
import {fullSizeImage, headerWidth,  bannerImageHeight, bannerImageWidth, previewDisplay, gridTwoToThree} from '../Sizes/__width'
//margins
const margin_top = `
